...
tabs = st.tabs([
    ...
    t["details"], t["identifiers"], t["candidates"], t["raw"], t["comparison"], t["report_center"]
])
with tabs[0]:
...
with tabs[10]:
    ...
    if not report_files:
        ...
        with d1:
            st.download_button(
                t["download_excel"], excel, "GradeX_Software_Compliance_Report_Sprint7.xlsx",
                "application/vnd.openxmlformats-officedocument.spreadsheetml.sheet",
                type="primary", width="stretch"
            )
        with d2:
            st.download_button(
                t["download_pdf"], pdf, "GradeX_Software_Compliance_Report_Sprint7.pdf",
