...
with st.spinner("Running Sprint 5 compliance analysis and report preparation…"):
...
with tabs[8]:
    ...
    if not report_files:
        ...
        with d1:
            st.download_button(
                t["download_excel"], excel, "GradeX_Software_Compliance_Report_Sprint5.xlsx",
                "application/vnd.openxmlformats-officedocument.spreadsheetml.sheet",
                type="primary", width="stretch"
            )
        with d2:
            st.download_button(
                t["download_pdf"], pdf, "GradeX_Software_Compliance_Report_Sprint5.pdf",
